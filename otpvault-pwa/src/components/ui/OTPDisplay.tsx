...
export function OTPDisplay({
  ...
  return (
    <div
      className="bg-white dark:bg-surface-800 rounded-2xl border border-surface-200/60 dark:border-surface-700/60 hover:border-surface-300 dark:hover:border-surface-600 hover:shadow-sm transition-all select-none relative overflow-hidden cursor-pointer"
      onClick={onCopy}
    >
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative w-9 h-9 flex items-center justify-center">
            <svg width="36" height="36" viewBox="0 0 36 36" className="transform -rotate-90">
              <circle cx="18" cy="18" r="13" fill="none" strokeWidth="3" className="stroke-surface-200 dark:stroke-surface-700" />
              <circle
                cx="18" cy="18" r="13" fill="none" strokeWidth="3" strokeLinecap="round"
          ...
          <div className="w-8 h-8 flex items-center justify-center rounded-lg text-surface-400 hover:text-primary-500 hover:bg-primary-50 dark:hover:bg-primary-950 transition-colors">
            {copied ? (
