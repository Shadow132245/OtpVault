  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'We do not sell, trade, or share your personal information with third parties. Encrypted vault data may be stored on Neon database infrastructure for cloud backup functionality.',
      },
      {
        heading: 'Your Rights',
  ...
  ar: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'لا نبيع أو نتبادل أو نشارك معلوماتك الشخصية مع أطراف ثالثة. قد تُخزّن بيانات الخزنة المشفرة على بنية Neon التحتية لوظيفة النسخ الاحتياطي السحابي.',
      },
      {
        heading: 'حقوقك',
...
export const termsOfService: Record<string, LegalDocument> = {
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'OtpVault is a web-based two-factor authentication (2FA) manager that stores your TOTP secrets in an encrypted vault with cloud backup. The app runs entirely in your browser.',
      },
      {
  ...
  ar: {
    ...
    sections: [
      ...
      {
        heading: 'وصف الخدمة',
        body: 'OtpVault هو مدير للتحقق بخطوتين (2FA) يعتمد على الويب يخزّن أسرار TOTP الخاصة بك في خزنة مشفرة مع نسخ احتياطي سحابي. يعمل التطبيق بالكامل في متصفحك.',
      },
      {
